...
import com.womai.m.mip.channel.util.SourceValidator;
...
public abstract class BaseController {
    ...
    protected boolean sourceValidate(String mipSourceId) {
        ...
        if (StringUtils.isBlank(mipSourceId)) {
            ...
            logger.error("Invalid mipSourceId:{}", mipSourceId);
            return false;
        }
        return true;
    }
    ...
    protected boolean isValidMipSource(String mipSourceId) {
        ...
        if (legalSourceSet.contains(mipSourceId)) {
            return true;
        } else {
            logger.info("Check mipSource {} from cache", mipSourceId);
            return sourceValidator.isValid(mipSourceId);
        }
